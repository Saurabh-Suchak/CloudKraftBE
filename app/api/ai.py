"""
AI-powered architecture generation endpoint.

Accepts a natural language prompt and returns a WorkflowState JSON
generated by Claude that can be loaded directly onto the canvas.
"""
    ...
    try:
        ...
        message = client.messages.create(
            ...
            messages=[
                {
                    "role": "user",
                    "content": f"Generate a CloudKraft architecture for: {request.prompt.strip()}",
                }
            ],
        )
        ...
        return AIGenerateResponse(
            ...
            description=f"Generated {len(workflow_state['nodes'])} resources for: {request.prompt.strip()}",
        )
